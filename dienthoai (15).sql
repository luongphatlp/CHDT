...
-- Thời gian đã tạo: Th3 27, 2026 lúc 09:18 AM
...
('DT001', 'Obsidian', 'LTPO OLED', '6.7 inch', 'Google Tensor G3', '12GB', 256, 11, 50, 5050, 'Android', 12),
...
('HD001', 'DT001', 1, 22000000),
('HD02', 'DT02', 1, 25000000),
('HD03', 'DT07', 1, 31000000),
('HD037', 'DT001', 1, 25000000),
...
('DT001', 'Google Pixel 8 Pro', 6, 25000000, '12GB / 256GB'),
...
('HD001', '2026-03-01 00:00:00', 'NV002', 'KH001', 22000000, 'Tiền mặt'),
('HD02', '2026-03-02 00:00:00', 'NV03', 'KH02', 25000000, 'Chuyển khoản'),
('HD03', '2026-03-03 00:00:00', 'NV02', 'KH03', 31000000, 'Tiền mặt'),
('HD037', '2026-03-26 16:25:04', 'NV024', 'KH011', 25000000, 'Tiền mặt'),
...
('KH001', 'Nguyễn Văn An', '0901112233', 'an.nv@gmail.com'),
('KH002', 'Trần Thị Bích', '0912223344', 'bich.tt@gmail.com'),
...
('KH011', 'Phat', '0924711466', 'phat@gmail.com');
...
--
-- Cấu trúc bảng cho bảng `lan_baohanh`
--

CREATE TABLE `lan_baohanh` (
  `maLanBH` int(11) NOT NULL,
  `IMEI` varchar(50) NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `lan_baohanh`
--

INSERT INTO `lan_baohanh` (`maLanBH`, `IMEI`, `ngayNhan`, `ngayTra`, `tinhTrang`, `xuLy`, `trangThai`) VALUES
(1, '356789100000001', '2026-03-27', '2026-03-27', 'Hư màn hình', 'Thay màn', 'Hoàn thành'),
(2, '356789100000002', '2026-03-27', '2026-03-27', 'chai pin', 'thay pin', 'Hoàn thành'),
(3, '356789100000001', '2026-03-27', '2026-03-27', 'Chai pin', 'thay pin', 'Hoàn thành'),
(4, '356789100000001', '2026-03-27', '2026-03-27', 'Nóng máy', 'Thay nguồn', 'Hoàn thành');
...
--
-- Chỉ mục cho bảng `lan_baohanh`
--
ALTER TABLE `lan_baohanh`
  ADD PRIMARY KEY (`maLanBH`);
...
--
-- AUTO_INCREMENT cho bảng `lan_baohanh`
--
ALTER TABLE `lan_baohanh`
  MODIFY `maLanBH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
